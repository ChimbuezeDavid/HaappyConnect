...
export default function SearchScreen() {
  ...
  return (
    <View className="flex-1 bg-slate-55 dark:bg-slate-950 px-4 pt-4 max-w-2xl w-full self-center">
      {/* Search Input */}
        ...
        <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
          {results.map((expert) => (
            <TouchableOpacity
              ...
              className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800/80 rounded-2xl p-4 mb-4 flex-row items-center shadow-sm dark:shadow-none"
            >
              <Image
              ...
              <View className="flex-1 ml-4 pr-2">
                ...
                <View className="flex-row items-center mt-1">
                  ...
                  <Text className="text-slate-400 dark:text-slate-500 text-xs ml-1">({expert.reviewsCount})</Text>
                </View>
              </View>
